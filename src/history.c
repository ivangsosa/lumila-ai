        ...
        if (root) {
            ...
            if (pid && json_is_integer(pid)) {
                ...
                switch (id) {
                    ...
                    case 6: model = "Ollama Llama 3.3"; break;
                    case 7: model = "Ollama Qwen3"; break;
                    case 8: model = "OpenRouter Quasar"; break;
                    case 9: model = "DeepSeek Chat"; break;
                    case 10: model = "DeepSeek Reasoner"; break;
                    case 11: model = "Mistral Large"; break;
                    case 12: model = "Ollama Mistral Small"; break;
                    case 13: model = "OpenRouter Free"; break;
